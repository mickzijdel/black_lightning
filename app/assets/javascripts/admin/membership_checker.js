// Script for the membership checker. This script is used to check if a user is a member of the site using the check_membership action in the membership controller

function initMembershipChecker() {
  var form = document.getElementById('membership-checker-form');

  // Only run on the membership checker page
  if (!form) return;
...
document.addEventListener('turbo:load', initMembershipChecker);