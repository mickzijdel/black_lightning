...
class EditableBlockHelperTest < ActionView::TestCase
  ...
  test "should give warning for non-exising editable block" do
    assert_equal 'Block not defined. <a class="btn btn-primary" title="Create Editable Block" href="/admin/editable_blocks/new?name=pineapple"><span class="no-wrap"><i class="fas fa-align-left" aria-hidden="true"></i> Create Editable Block</span></a>', display_block("pineapple", false)
  end
