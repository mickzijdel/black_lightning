...
class LinkHelperTest < ActionView::TestCase
  ...
  test "remove_button_text" do
    default_remove_button_text = '<span class="no-wrap"><i class="fas fa-trash" aria-hidden=”true”></i> Remove</span>'.html_safe
    assert_equal default_remove_button_text, remove_button_text

    other_remove_button_text = '<span class="no-wrap"><i class="fas fa-trash" aria-hidden=”true”></i> Pineapple</span>'.html_safe
  ...
  test "get_link with destroy" do
    ...
    expected_link = "<a class=\"btn btn-danger\" data-title=\"Deleting the News &quot;Vikings have taken over the Bedlam&quot;\" data-turbo-confirm=\"Are you sure you want to delete the News &quot;Vikings have taken over the Bedlam&quot;?\" data-turbo-method=\"delete\" title=\"Destroy\" href=\"/admin/news/1-vikings-have-taken-over-the-bedlam\"><span class=\"no-wrap\"><i class=\"fas fa-trash\" aria-hidden=\"true\"></i> Destroy</span></a>"
  ...
  test "get_link with approve" do
    ...
    expected_link = "<a class=\"btn btn-success\" data-turbo-method=\"put\" title=\"Approve\" href=\"/admin/opportunities/1/approve\">Approve</a>"
  ...
  test "get_link with reject" do
    news = FactoryBot.create(:opportunity, id: 1)
    expected_link = '<a class="btn btn-danger" data-turbo-method="put" title="Reject" href="/admin/opportunities/1/reject">Reject</a>'
  ...
  test "get_link with custom action" do
    ...
    expected_link = "<a class=\"btn btn-secondary\" data-turbo-method=\"put\" title=\"Convert To Staffing Debt\" href=\"/admin/maintenance_debts/1/convert_to_staffing_debt\">Convert To Staffing Debt</a>"
  ...
  test "return link text when condition fails for other action" do
    ...
    assert_equal '<span class="no-wrap"><i class="fas fa-pencil-alt" aria-hidden=”true”></i> Edit</span>', get_link(staffing, :edit, condition: false, return_link_text_if_no_permission: true)
  end
  ...
  test "default generate_link_text for instances with name propery" do
    ...
    instance_hash = {
      ...
      edit: '<span class="no-wrap"><i class="fas fa-pencil-alt" aria-hidden=”true”></i> Edit</span>',
      destroy: '<span class="no-wrap"><i class="fas fa-trash" aria-hidden=”true”></i> Destroy</span>',
      answer: "Answer"
    }
  ...
  test "default generate_link_text for classes" do
    ...
    class_hash = {
      index: '<span class="no-wrap"><i class="fas fa-th-list" aria-hidden=”true”></i> Show All</span> Maintenance Debts',
      new: '<span class="no-wrap"><i class="fas fa-plus" aria-hidden=”true”></i> New</span> Maintenance Debt'
    }
  ...
  test "get_confirm_data" do
    ...
    # verify is embedded in turbo_confirm message, not a separate key
    confirm_hash = {
      title: "Hexagon",
      turbo_confirm: "[VERIFY:Pineapple]"
    }
  ...
  test "get_confirm_data for destroy" do
    ...
    # verify is no longer a separate key (embedded in turbo_confirm when present)
