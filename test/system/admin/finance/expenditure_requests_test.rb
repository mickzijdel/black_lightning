...
class Admin::Finance::ExpenditureRequestsTest < ApplicationSystemTestCase
  ...
  test "should create Expenditure request" do
    ...
    fill_in "Amount cents", with: @admin_finance_expenditure_request.amount_cents
    ...
    fill_in "Proof state", with: @admin_finance_expenditure_request.proof_status
    fill_in "Submitter notes", with: @admin_finance_expenditure_request.submitter_notes
    fill_in "Transaction state", with: @admin_finance_expenditure_request.request_status
